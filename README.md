...
# Optional: Configure PHPMailer for Your Project
...
Go to [https://myaccount.google.com](https://myaccount.google.com), type **"app password"** into the search bar, and create a new app password.
