...
# Recommended/Optional: Configure PHPMailer for your project to send emails using Gmail Secure Apps. You need to have 2 Factor Auth turned on in your gmail account that you are using. If you dont have this, nothing in this will work
